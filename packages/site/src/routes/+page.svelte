<script lang="ts">
    ...
    reader.onload = function () {
        ...
        if (isIGOOD(json)) {
            good = json;
            characters = json.characters?.map((character => ({key: character.key, checked: false}))).sort() ?? []
...
<div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
    <Paper>
        <Content>
            ...
            <div class="mt-4">
                See Genshin Optimizer for a description of the <a href="https://frzyc.github.io/genshin-optimizer/#/doc">GOOD</a> format as well as available <a href="https://frzyc.github.io/genshin-optimizer/#/scanner">scanners</a> for obtaining the file you need to upload.
            </div>
        </Content>
    </Paper>
</div>
<CharacterSelect open={characterSelectOpen} characters={characters} on:modalConfirm={onModalConfirm}/>
<BuildLink open={buildLinkOpen} build={build}/>