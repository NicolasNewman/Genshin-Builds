...
${binPad(
	characterWeaponIDs[build.character.character][build.weapon?.weapon || '_']?.toString(2) ?? 0,
	6
)}\
...
${binPad(
	subStatValueIDs[(build.artifacts.flower?.rarity ?? -1) + 1][
		build.artifacts.flower?.substatOne ?? '_'
	][build.artifacts.flower?.substatOneRoll ?? '_'].toString(2),
	6
)}\
${binPad(artifactSSIDs[build.artifacts.flower?.substatTwo || '_'].toString(2) ?? 0, 4)}\
${binPad(
	subStatValueIDs[(build.artifacts.flower?.rarity ?? -1) + 1][
		build.artifacts.flower?.substatTwo ?? '_'
	][build.artifacts.flower?.substatTwoRoll ?? '_'].toString(2),
	6
)}\
${binPad(artifactSSIDs[build.artifacts.flower?.substatThree || '_'].toString(2) ?? 0, 4)}\
${binPad(
	subStatValueIDs[(build.artifacts.flower?.rarity ?? -1) + 1][
		build.artifacts.flower?.substatThree ?? '_'
	][build.artifacts.flower?.substatThreeRoll ?? '_'].toString(2),
	6
)}\
${binPad(artifactSSIDs[build.artifacts.flower?.substatFour || '_'].toString(2) ?? 0, 4)}\
${binPad(
	subStatValueIDs[(build.artifacts.flower?.rarity ?? -1) + 1][
		build.artifacts.flower?.substatFour ?? '_'
	][build.artifacts.flower?.substatFourRoll ?? '_'].toString(2),
	6
)}\
...
${binPad(
	subStatValueIDs[(build.artifacts.plume?.rarity ?? -1) + 1][
		build.artifacts.plume?.substatOne ?? '_'
	][build.artifacts.plume?.substatOneRoll ?? '_'].toString(2),
	6
)}\
${binPad(artifactSSIDs[build.artifacts.plume?.substatTwo || '_'].toString(2) ?? 0, 4)}\
${binPad(
	subStatValueIDs[(build.artifacts.plume?.rarity ?? -1) + 1][
		build.artifacts.plume?.substatTwo ?? '_'
	][build.artifacts.plume?.substatTwoRoll ?? '_'].toString(2),
	6
)}\
${binPad(artifactSSIDs[build.artifacts.plume?.substatThree || '_'].toString(2) ?? 0, 4)}\
${binPad(
	subStatValueIDs[(build.artifacts.plume?.rarity ?? -1) + 1][
		build.artifacts.plume?.substatThree ?? '_'
	][build.artifacts.plume?.substatThreeRoll ?? '_'].toString(2),
	6
)}\
${binPad(artifactSSIDs[build.artifacts.plume?.substatFour || '_'].toString(2) ?? 0, 4)}\
${binPad(
	subStatValueIDs[(build.artifacts.plume?.rarity ?? -1) + 1][
		build.artifacts.plume?.substatFour ?? '_'
	][build.artifacts.plume?.substatFourRoll ?? '_'].toString(2),
	6
)}\
...
${binPad(
	subStatValueIDs[(build.artifacts.sands?.rarity ?? -1) + 1][
		build.artifacts.sands?.substatOne ?? '_'
	][build.artifacts.sands?.substatOneRoll ?? '_'].toString(2),
	6
)}\
${binPad(artifactSSIDs[build.artifacts.sands?.substatTwo || '_'].toString(2) ?? 0, 4)}\
${binPad(
	subStatValueIDs[(build.artifacts.sands?.rarity ?? -1) + 1][
		build.artifacts.sands?.substatTwo ?? '_'
	][build.artifacts.sands?.substatTwoRoll ?? '_'].toString(2),
	6
)}\
${binPad(artifactSSIDs[build.artifacts.sands?.substatThree || '_'].toString(2) ?? 0, 4)}\
${binPad(
	subStatValueIDs[(build.artifacts.sands?.rarity ?? -1) + 1][
		build.artifacts.sands?.substatThree ?? '_'
	][build.artifacts.sands?.substatThreeRoll ?? '_'].toString(2),
	6
)}\
${binPad(artifactSSIDs[build.artifacts.sands?.substatFour || '_'].toString(2) ?? 0, 4)}\
${binPad(
	subStatValueIDs[(build.artifacts.sands?.rarity ?? -1) + 1][
		build.artifacts.sands?.substatFour ?? '_'
	][build.artifacts.sands?.substatFourRoll ?? '_'].toString(2),
	6
)}\
...
${binPad(
	subStatValueIDs[(build.artifacts.goblet?.rarity ?? -1) + 1][
		build.artifacts.goblet?.substatOne ?? '_'
	][build.artifacts.goblet?.substatOneRoll ?? '_'].toString(2),
	6
)}\
${binPad(artifactSSIDs[build.artifacts.goblet?.substatTwo || '_'].toString(2) ?? 0, 4)}\
${binPad(
	subStatValueIDs[(build.artifacts.goblet?.rarity ?? -1) + 1][
		build.artifacts.goblet?.substatTwo ?? '_'
	][build.artifacts.goblet?.substatTwoRoll ?? '_'].toString(2),
	6
)}\
${binPad(artifactSSIDs[build.artifacts.goblet?.substatThree || '_'].toString(2) ?? 0, 4)}\
${binPad(
	subStatValueIDs[(build.artifacts.goblet?.rarity ?? -1) + 1][
		build.artifacts.goblet?.substatThree ?? '_'
	][build.artifacts.goblet?.substatThreeRoll ?? '_'].toString(2),
	6
)}\
${binPad(artifactSSIDs[build.artifacts.goblet?.substatFour || '_'].toString(2) ?? 0, 4)}\
${binPad(
	subStatValueIDs[(build.artifacts.goblet?.rarity ?? -1) + 1][
		build.artifacts.goblet?.substatFour ?? '_'
	][build.artifacts.goblet?.substatFourRoll ?? '_'].toString(2),
	6
)}\
...
${binPad(
	subStatValueIDs[(build.artifacts.circlet?.rarity ?? -1) + 1][
		build.artifacts.circlet?.substatOne ?? '_'
	][build.artifacts.circlet?.substatOneRoll ?? '_'].toString(2),
	6
)}\
${binPad(artifactSSIDs[build.artifacts.circlet?.substatTwo || '_'].toString(2) ?? 0, 4)}\
${binPad(
	subStatValueIDs[(build.artifacts.circlet?.rarity ?? -1) + 1][
		build.artifacts.circlet?.substatTwo ?? '_'
	][build.artifacts.circlet?.substatTwoRoll ?? '_'].toString(2),
	6
)}\
${binPad(artifactSSIDs[build.artifacts.circlet?.substatThree || '_'].toString(2) ?? 0, 4)}\
${binPad(
	subStatValueIDs[(build.artifacts.circlet?.rarity ?? -1) + 1][
		build.artifacts.circlet?.substatThree ?? '_'
	][build.artifacts.circlet?.substatThreeRoll ?? '_'].toString(2),
	6
)}\
${binPad(artifactSSIDs[build.artifacts.circlet?.substatFour || '_'].toString(2) ?? 0, 4)}\
${binPad(
	subStatValueIDs[(build.artifacts.circlet?.rarity ?? -1) + 1][
		build.artifacts.circlet?.substatFour ?? '_'
	][build.artifacts.circlet?.substatFourRoll ?? '_'].toString(2),
	6
)}\
`;
		return b2to64(str);
