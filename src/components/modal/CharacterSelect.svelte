<script lang="ts">
	...
	import { truncateName } from '$lib/helper';
	import { createEventDispatcher } from 'svelte';
	import type { CharacterSelectFieldData } from 'src/types/ui';
    ...
    function confirm() {
        dispatch('modalConfirm', characters.filter(character => character.checked))
    }
</script>
